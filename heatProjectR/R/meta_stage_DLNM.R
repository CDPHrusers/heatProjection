...
meta_stage_DLNM<-function(first_stage_list = first_stage, output_path_num = "/data/processed/attributable_number_zips.csv",output_path_frac = "/data/processed/attributable_frac_zips.csv"){
...
source("code/attrdl.R") #fix pathway
...
# CITY-SPECIFIC
anzip <- matsim
anziplow <- apply(arraysim,c(1,2),quantile,0.025)
anziphigh <- apply(arraysim,c(1,2),quantile,0.975)
